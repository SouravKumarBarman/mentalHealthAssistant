...
//       {/* Hero Section */}
//       <section className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-center py-20 flex flex-col items-center justify-center">
//         <motion.h1 
...
//         </motion.h1>
//         <Typography variant="body1" className="text-lg max-w-2xl mx-auto">
//           A safe space for guidance, support, and self-care. Start your journey towards better mental health today.
//         </Typography>
//         <Button 
//           variant="contained" 
//           color="secondary"
//           className="mt-6 px-8 py-3 text-lg rounded-lg shadow-lg"
//         >
//           Start Your Journey
//         </Button>
//       </section>
...
//         <Typography variant="h4" className="text-center font-semibold text-gray-800 mb-10">
...
//               <Card className="p-8 flex flex-col items-center text-center shadow-lg rounded-2xl bg-white transition-transform transform hover:-translate-y-2 hover:shadow-xl">
//                 <feature.icon className="text-blue-600 text-5xl mb-4" />
//                 <Typography variant="h6" className="text-gray-800 font-semibold mb-2">{feature.title}</Typography>
...
//           className="flex items-center justify-center px-6 py-3 text-lg rounded-lg shadow-lg"
//         >
...
//         </Typography>
//         <Link to="/meditation">
//           <Button variant="contained" color="secondary" className="px-8 py-3 text-lg rounded-lg shadow-lg">
//             Start Meditation
//           </Button>
//         </Link>
//       </section>
...
//         </Typography>
//         <Button variant="contained" color="error" className="px-8 py-3 text-lg rounded-lg shadow-lg">
